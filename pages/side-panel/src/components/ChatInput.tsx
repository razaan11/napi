...
export default function ChatInput({
  ...
  return (
    <form
      ...
      className={`overflow-hidden rounded-lg border transition-colors ${disabled ? 'cursor-not-allowed' : 'focus-within:border-yellow-400 hover:border-yellow-400'} ${isDarkMode ? 'border-slate-700' : ''}`}
        ...
        <div
          ...
          {showStopButton ? (
            ...
            <button
              ...
              className={`rounded-md bg-[#EAB308] px-3 py-1 text-white transition-colors hover:enabled:bg-[#A16207] ${isSendButtonDisabled ? 'cursor-not-allowed opacity-50' : ''}`}>
              {t('chat_buttons_send')}
            </button>
          )}
        </div>
