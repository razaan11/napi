        ...
        {bookmarks.map(bookmark => (
          <div
            ...
            className={`group relative rounded-lg p-3 ${
              isDarkMode ? 'bg-slate-800 hover:bg-slate-700' : 'bg-white hover:bg-yellow-50'
            } border ${isDarkMode ? 'border-slate-700' : 'border-yellow-100'}`}>
                ...
                <input
                  ...
                  className={`mr-2 grow rounded px-2 py-1 text-sm ${
                    isDarkMode
                      ...
                      : 'border-yellow-100 bg-white text-gray-700'
                  } border`}
                />
                <button
