...
export const ModelSettings = ({ isDarkMode = false }: ModelSettingsProps) => {
            ...
            <div className="flex flex-1 items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  className={`w-20 rounded-md border ${isDarkMode ? 'border-slate-600 bg-slate-700 text-gray-200 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-800' : 'border-gray-300 bg-white text-gray-700 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-200'} px-2 py-1 text-sm`}
  ...
  return (
    <section className="space-y-6">
      ...
      <div
        className={`rounded-lg border ${isDarkMode ? 'border-slate-700 bg-slate-800' : 'border-yellow-100 bg-gray-50'} p-6 text-left shadow-sm`}>
            ...
            getSortedProviders().map(([providerId, providerConfig]) => {
              ...
              return (
                <div
                  ...
                  className={`space-y-4 ${modifiedProviders.has(providerId) && !providersFromStorage.has(providerId) ? `rounded-lg border p-4 ${isDarkMode ? 'border-yellow-700 bg-slate-700' : 'border-yellow-200 bg-yellow-50/70'}` : ''}`}>
                  ...
                  <div className="space-y-3">
                          ...
                          <input
                            ...
                            className={`flex-1 rounded-md border p-2 text-sm ${
                              nameErrors[providerId]
                                ...
                                : isDarkMode
                                  ? 'border-yellow-700 bg-slate-700 text-gray-200 focus:border-yellow-600 focus:ring-2 focus:ring-yellow-900'
                                  : 'border-yellow-300 bg-gray-50 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-200'
                            } outline-none`}
                          />
                        </div>
                        {nameErrors[providerId] ? (
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="relative flex-1">
                        <input
                          ...
                          className={`w-full rounded-md border text-sm ${isDarkMode ? 'border-slate-600 bg-slate-700 text-gray-200 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-800' : 'border-gray-300 bg-white text-gray-700 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-200'} p-2 outline-none`}
                        />
                      ...
                      <div className="flex flex-col">
                        <div className="flex items-center">
                          ...
                          <input
                            ...
                            className={`flex-1 rounded-md border text-sm ${isDarkMode ? 'border-slate-600 bg-slate-700 text-gray-200 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-800' : 'border-gray-300 bg-white text-gray-700 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-200'} p-2 outline-none`}
                          />
                        </div>
                      </div>
                    )}
                          ...
                          <div
                            ...
                            {(providerConfig.azureDeploymentNames || []).length > 0
                              ? (providerConfig.azureDeploymentNames || []).map((deploymentName: string) => (
                                  <div
                                    key={deploymentName}
                                    className={`flex items-center rounded-full ${isDarkMode ? 'bg-yellow-900 text-yellow-100' : 'bg-yellow-100 text-yellow-800'} px-2 py-1 text-sm`}>
                                    <span>{deploymentName}</span>
                                    <button
                                      type="button"
                                      onClick={() => removeAzureDeployment(providerId, deploymentName)}
                                      className={`ml-1 font-bold ${isDarkMode ? 'text-yellow-300 hover:text-yellow-100' : 'text-yellow-600 hover:text-yellow-800'}`}
                    ...
                    {providerConfig.type === ProviderTypeEnum.Ollama && (
                      <div
                        className={`mt-4 rounded-md border ${isDarkMode ? 'border-slate-600 bg-slate-700' : 'border-yellow-100 bg-yellow-50'} p-3`}>
                        <p className={`text-sm ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>
                          <strong>
                            {' '}
                            <code
                              className={`rounded italic ${isDarkMode ? 'bg-slate-600 px-1 py-0.5' : 'bg-yellow-100 px-1 py-0.5'}`}>
                          ...
                          <a
                            ...
                            className={`ml-1 ${isDarkMode ? 'text-yellow-400 hover:text-yellow-300' : 'text-yellow-600 hover:text-yellow-800'}`}>
          ...
          <div className="provider-selector-container relative pt-4">
            <Button
              ...
              className={`flex w-full items-center justify-center font-medium ${
                isDarkMode
                  ? 'border-yellow-700 bg-yellow-600 text-white hover:bg-yellow-500'
            ...
            {isProviderSelectorOpen && (
              <div
                className={`absolute z-10 mt-2 w-full overflow-hidden rounded-md border ${
                  isDarkMode
                    ? 'border-yellow-600 bg-slate-700 shadow-lg shadow-slate-900/50'
                    : 'border-yellow-200 bg-white shadow-xl shadow-yellow-100/50'
                }`}>
                <div className="py-1">
                    ...
                    .map(type => (
                      <button
                        ...
                        className={`flex w-full items-center px-4 py-3 text-left text-sm ${
                          isDarkMode
                            ? 'text-yellow-200 hover:bg-yellow-600/30 hover:text-white'
